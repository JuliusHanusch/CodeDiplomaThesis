...
srun python3 ./src/hpo.py --config ./src/search_configs/tiny_t5.yml --worker-walltime "7-00:00:00" --worker-count 20 --job-extra-directives "['--gres=gpu:2']" --memory "320G"

sbatch --dependency=afterany:$SLURM_JOB_ID ./hpc/searches/run_search_tiny_stage_2.sh